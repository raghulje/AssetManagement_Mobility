...
const LABEL_STYLE: Record<string, { color: string; icon: string }> = {
  ...
  'Active employees': { color: 'bg-teal', icon: 'fas fa-user-check' },
  'Inactive employees': { color: 'bg-maroon', icon: 'fas fa-user-slash' },
  'All employees': { color: 'bg-navy', icon: 'fas fa-users' },
